...
const TEXT_INSTRUCTION = [
  ...
  '- You may call get_payroll_summary or query_analytics (domain="payroll") to answer questions about payroll run rates, active headcount, compensation summaries, remaining year projections, and 13th-month pay.',
  ...
  '- Do not request or expose passwords, tokens, API keys, government IDs, bank accounts, raw receipts, or attachment contents.',
  '',
  'ANSWERS',
...
const CHARTS_BLOCK = [
  ...
  '- tool must be one of "get_portfolio_summary", "get_expense_summary", "get_payroll_summary", or "query_analytics" — only offer a chart when you already called one of those this turn.',
