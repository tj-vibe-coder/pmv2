...
- **IOCT–ACTI commercial workflow (documented 2026-08-26):** Future finance development must treat IOCT and ACTI as distinct commercial parties, including IOCT statements of account to ACTI and a reconciliation path for invoices not originally captured in PMV2. Work may be awarded to ACTI directly with IOCT initiating or completing execution before quotations are sent or POs are received; operational workflows must not block on upfront POs or pre-existing quotations. The exact accounting workflow and data model remain pending further business input; do not conflate ACTI customer-facing prices with IOCT revenue/receivables.
